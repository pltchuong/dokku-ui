...
describe('Activity API:', function () {
  ...
  describe('GET /api/activities', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).get('/api/activities').expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        activitys = res.body;
  ...
  describe('POST /api/activities', function () {
    beforeEach(function (done) {
      (0, _supertest2.default)(app).post('/api/activities').send({
        name: 'New Activity',
  ...
  describe('GET /api/activities/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).get('/api/activities/' + newActivity._id).expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        activity = res.body;
  ...
  describe('PUT /api/activities/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).put('/api/activities/' + newActivity._id).send({
  ...
  describe('DELETE /api/activities/:id', function () {
    ...
    it('should respond with 204 on successful removal', function (done) {
      (0, _supertest2.default)(app).delete('/api/activities/' + newActivity._id).expect(204).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
    ...
    it('should respond with 404 when activity does not exist', function (done) {
      (0, _supertest2.default)(app).delete('/api/activities/' + newActivity._id).expect(404).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
...
//# sourceMappingURL=activity.integration.js.map
