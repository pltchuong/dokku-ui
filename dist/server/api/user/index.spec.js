...
describe('User API Router:', function () {
  ...
  describe('GET /api/users', function () {
    ...
    it('should route to user.controller.index', function () {
      routerStub.get.withArgs('/', 'userCtrl.index').should.have.been.calledOnce;
    });
  });
  ...
  describe('GET /api/users/:id', function () {
    ...
    it('should route to user.controller.show', function () {
      routerStub.get.withArgs('/:id', 'userCtrl.show').should.have.been.calledOnce;
    });
  });
  ...
  describe('PUT /api/users/:id', function () {
    ...
    it('should route to user.controller.update', function () {
      routerStub.put.withArgs('/:id', 'userCtrl.update').should.have.been.calledOnce;
    });
  });
  ...
  describe('PATCH /api/users/:id', function () {
    ...
    it('should route to user.controller.update', function () {
      routerStub.patch.withArgs('/:id', 'userCtrl.update').should.have.been.calledOnce;
    });
  });
  ...
  describe('DELETE /api/users/:id', function () {
    ...
    it('should route to user.controller.destroy', function () {
      routerStub.delete.withArgs('/:id', 'userCtrl.destroy').should.have.been.calledOnce;
    });
  });
});
