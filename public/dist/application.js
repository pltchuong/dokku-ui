...
var ApplicationConfiguration = (function () {
  ...
  var applicationModuleVendorDependencies = ['ngResource', 'ngAnimate', 'ngMessages', 'ui.router', 'ui.bootstrap', 'ui.utils', 'angularFileUpload', 'angularModalService', 'ui.select', 'ngSanitize'];
...
// Use Applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('dokku', ['core']);
...
angular.module('dokku').controller('AppBuildsController', ['$scope', '$rootScope', '$stateParams', '$http',
...
angular.module('dokku').controller('AppsController', ['$scope',
  function ($scope) {
...
angular.module('dokku').controller('ModalDeleteConfigController', ['$scope', 'key', 'value', 'close',
  function ($scope, key, value, close) {
    $scope.key = key;
    $scope.value = value;
...
angular.module('dokku').controller('ModalEditConfigController', ['$scope', 'key', 'value', 'close',
  function ($scope, key, value, close) {
    $scope.key = key;
    $scope.value = value;
